  ...
  return (
    <Link to="/" className="flex items-center gap-3 no-underline">
      ...
      <div className="flex flex-col leading-none">
        ...
        <span
          className="text-[8px] tracking-[0.22em] uppercase mt-1 pt-[2px] pb-px"
          style={{
            color: gold,
        ...
        <span className="sr-only" style={{ color: subColor }}>
          brand
        </span>
      </div>
    </Link>
